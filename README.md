...
> Projeto inspirado no `create-react-app`, mas usando AngularJS, apenas com um único `webpack.config.js` para resolver tudo. Baseado no meu repositório [`webpack-base`](https://github.com/yuigoto/webpack-base).
